...
class GraphsWidget extends StatelessWidget {
  const GraphsWidget({
    ...
    this.isyearly = false,
    this.axis = true, 
    this.plotbands=true, this.threshold
  ...
  Widget build(BuildContext context) {
    return SfCartesianChart(
        ...
        builder: (data, point, series, pointIndex, seriesIndex) => CardwithShadow(padding: const EdgeInsets.all(8),child: SizedBox(
          // height: 100,
          child: Column(
    ...
    series:[ charttype ==  ChartType.line?linecharts(data: seriesdata,color:  Colors.green):barcharts(data:  seriesdata,color:  Colors.grey[400]!,)],
    );
  }
}
