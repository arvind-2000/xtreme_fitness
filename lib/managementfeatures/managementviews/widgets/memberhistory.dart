...
class MemberServiceHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ManagementController>(builder: (managectrl) {
      return managectrl.getallpayments.where((element) =>element.userId==xtremers.XtremerId && element.paymentStatus!.toLowerCase()=="success" ).toList().isEmpty?TitleText("No service to show",color: Colors.grey[600],) : ConstrainedBox(
        constraints: BoxConstraints(maxWidth: 600),
        child: ListView(
            shrinkWrap: true,
            // element.userId==managectrl.xtremer!.XtremerId && element.paymentStatus!.toLowerCase()=="success",
            children:managectrl.getallpayments.where((element) =>element.userId==xtremers.XtremerId && element.paymentStatus!.toLowerCase()=="success" ).map((e) => CardwithShadow(
              ...
              child: Row(
                ...
                children: [
                  ...
                  children: [
                    ...
                    Text("Payment Method"),
                                Text("${e.paymentMethod}",style:  TextStyle(fontSize: 14,color: Colors.grey[300]),),
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    CardBorder(
                                                      ...
                                                      child: const Text("Download PDF",style: TextStyle(fontSize: 14),)),
