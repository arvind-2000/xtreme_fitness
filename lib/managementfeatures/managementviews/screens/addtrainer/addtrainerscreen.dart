               ...
               Column(
                    ...
                    children: [
                      ...
                      menuStyle: MenuStyle(backgroundColor: WidgetStateColor.resolveWith((states) => Theme.of(context).colorScheme.primary,)),
                        ...
                        hintText: timing,
                        dropdownMenuEntries: ['Morning','Evening'].map((e)=>DropdownMenuEntry(value: e, label: e,style: ButtonStyle(
                            ...
                            managectrl.getalltrainer.isEmpty
                                ...
                                : Expanded(
                                  child: GridView.builder(
                                      ...
                                      itemBuilder: (c, i) {
                                      bool _isactive = managectrl.getalltrainer[i].isActive;
                                            ...
                                            child: Column(
                                              children: [
                                                Row(
                                                  ...
                                                  CardwithShadow(
                                                      onpress: (){
                                                        _fullnamecontroller.text = managectrl.getalltrainer[i].name;
                                                        setState(() {
                                                          timing = managectrl.getalltrainer[i].timing;
                                                        }); 
                                                        Get.dialog(Dialog(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            const SizedBox(
                                                                             ...
                                                                             Column(
                                                                              ...
                                                                              SizedBox(height: 20,  ),
                                                                                  _isactive?const Text("Trainer Active"):const Text("Trainer Disabled"),
                                                                            Switch(
                                                                                    ...
                                                                                    showDialog(
                                                                                      ...
                                                                                      builder: (context) =>
                                                                                          PageDialog(
                                                                                              ...
                                                                                              await managectrl
                                                                                                    .edittrainer(
                                                                                                       TrainerEntity(id: managectrl.getalltrainer[i].id, name: _fullnamecontroller.text, designation: managectrl.getalltrainer[i].designation, timing: timing, isActive:_isactive));
                                                                                                Navigator.pop(context);
