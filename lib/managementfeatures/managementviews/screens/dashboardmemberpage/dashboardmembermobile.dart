...
class DashBoardMemberScreenmobile extends StatefulWidget {
  const DashBoardMemberScreenmobile({super.key});

  @override
  State<DashBoardMemberScreenmobile> createState() => _DashBoardMemberScreenmobileState();
}

class _DashBoardMemberScreenmobileState extends State<DashBoardMemberScreenmobile> {
        ...
        return GetBuilder<GetxPageController>(
          builder: (pagectrl) {
            return Column(
              ...
              //   )
              //   :SizedBox(),
               managectrl.xtremer!=null?Padding(
                 padding: const EdgeInsets.all(16.0),
                 child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                   children: [
                ...
                Center(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("Powered By",style: TextStyle(color: Theme.of(context).colorScheme.onPrimary.withOpacity(0.5)),),
                      const SizedBox(height: 10,),
                      SizedBox(
                        height: 80,
                        width: 80,
