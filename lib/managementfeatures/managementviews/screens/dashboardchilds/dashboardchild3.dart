      ...
      return CardwithShadow(
        ...
        child: Column(
          children: [
            ...
            managectrl.filterpayments.isEmpty
                ? const SizedBox()
                : Expanded(
                    child: Padding(
                    ...
                    child: GraphsWidget(
                      ...
                      graphaxisnames: (axisLabelRenderArgs) => ChartAxisLabel(
                          months[(managectrl.filterpayments.values
                                      .elementAt(int.tryParse(
                      ...
                      tooltip: (data, point, series, pointIndex, seriesIndex) =>
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(months[(managectrl.filterpayments.values
