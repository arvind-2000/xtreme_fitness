        ...
        return GetBuilder<GetxLandingcontroller>(
          builder: (landingctrl) {
                ...
                return ConstrainedBox(
                  ...
                  child:addmemberctrl.paymentstatus!=0?PaymentStatusCard(callback: (){},): Form(
                    key: _globalKey,
                              ...
                              const SizedBox(height: 16,),
                               ...
                               physics: NeverScrollableScrollPhysics(),
                                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                  ...
                                  crossAxisCount: size<500?1:size<mobilescreen?2: size>mobilescreen && size<1200?3:3,
                                  mainAxisSpacing: 16,
                                  crossAxisSpacing: 16,
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                           children: [
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                            Icon(addmemberctrl.selectedservice!=null&&addmemberctrl.selectedservice!.id==e.value.id?Icons.check:Icons.add,color: Colors.white,),
                                            const SizedBox(width: 10,),
                                      
                                          addmemberctrl.selectedservice!=null&&addmemberctrl.selectedservice!.id==e.value.id?const Text("Service Added",style: TextStyle(color: Colors.white)):Text("Add Service",style: TextStyle(color: Colors.white),)
                                          ],))
                                  ...
                                  Center(
                                    child: ConstrainedBox(
                                      ...
                                      child: Column(
                                        children: [
                                          NormalText(text:"Bill Details",size: 16,),            Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                            Text("Amount"),
                                            Text("Rs . ${addmemberctrl.selectedservice!.nonMemberPrice}")
                                          ],),
                                          SizedBox(height: 16,),
                                          ...
                                          Cardonly(
                                            ...
                                            onpress: ()async{
                                              // create user 
                                          bool v  = await addmemberctrl.createuser(widget.phonenumber, widget.phonenumber,widget.phonenumber);
                                              // payments
                                            print("In service id : ${addmemberctrl.selectedservice!.id}");
                                            if(v){
                      
                                              addmemberctrl.addServiceusage(paymentonline: false);
                                            }else{
