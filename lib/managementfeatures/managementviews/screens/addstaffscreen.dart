...
class _AddStaffScreenState extends State<AddStaffScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (timeStamp) {
        rolelist = Get.put(ManagementController())
            .getallRoles
            .where((element) =>
                element.roleName.toLowerCase() != "superadmin" &&
                element.roleName.toLowerCase() != "member" &&
                element.roleName.toLowerCase() != "servicemember")
            .toList();
                                                                ...
                                                                children: [
                                                                  Expanded(
                                                                      child: CardwithShadow(
                                                                          ...
                                                                          child: const Text(
                                                                            "Check Staff details before Adding?\nPress OK to confirm",
                                                                            textAlign:
                                                                                TextAlign.center,
                                                                          )))
                                                                ],
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            HeadingText(
                                "Staff (${managectrl.getallstaff.length})"),
                            CardBorder(
                                onpress: addstaff,
                                padding: const EdgeInsets.symmetric(
                                    vertical: 8, horizontal: 16),
                        ...
                        managectrl.getallstaff.isEmpty
                            ? const Expanded(
                                child: NodataScreen(
                                    title: "Staff", desc: " No Staff to show"))
                            : Expanded(
                                child: GridView(
                                    shrinkWrap: true,
                                    gridDelegate:
                                    ...
                                    children: managectrl.getallstaff
                                        .where(
                                      (element) =>
                                          element.isActive == isactive &&
                                          '${element.roleName?.toLowerCase()}' !=
                                              "superadmin" &&
                                          '${element.roleName?.toLowerCase()}' !=
                                              "member" &&
                                          '${element.roleName?.toLowerCase()}' !=
                                                                ...
                                                                return PageDialog(
                                                                    ...
                                                                    yes: () {
                                                                      if (_globalkey2
                                                                          .currentState!
                                                                          .validate()) {
                                                                        managectrl.updateStaffs(UserEntity(
