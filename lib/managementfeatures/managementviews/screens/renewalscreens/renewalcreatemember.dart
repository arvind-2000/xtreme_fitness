...
class RenewalCreateMember extends StatefulWidget {
  const RenewalCreateMember({super.key, this.phone, this.renewal});
  final String? phone;
  final int? renewal;
  @override
  State<RenewalCreateMember> createState() => _RenewalCreateMemberState();
}

class _RenewalCreateMemberState extends State<RenewalCreateMember> {
          ...
          child: Center(
            child: ConstrainedBox(
              ...
              child:addmemberctrl.paymentstatus!=0?const PaymentStatusCard():Column(
                ...
                children: [
                  //upload image
                 widget.renewal==null?const SizedBox(): SizedBox(
                    height: 100,
                    width: 100,
                  ...
                  widget.renewal==null?const SizedBox(): Text(
                  ...
                  Form(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                         widget.renewal==null?const SizedBox():TextFieldWidget(
                                  enabletext:!addmemberctrl.isloading, 
                            
                              hint: "User Name", controller: username,),
                         widget.renewal==null?const SizedBox():  const SizedBox(
                            height: 16,
                          ),
                           widget.renewal==null?const SizedBox():TextFieldWidget(
                            enabletext: !addmemberctrl.isloading,
                                      ...
                                      return PageDialog(
                                          ...
                                          child: Form(
                                            ...
                                            child: Column(
                                              ...
                                              widget.renewal==null?const SizedBox():Row(
                                                  mainAxisAlignment:
                                                      MainAxisAlignment
                                                          .spaceBetween,
                                                  children: [
