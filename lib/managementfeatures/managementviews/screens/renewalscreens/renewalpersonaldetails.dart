...
class RenewalPersonaldetailsField extends StatefulWidget {
  const RenewalPersonaldetailsField({
    super.key,
  ...
  @override
  State<RenewalPersonaldetailsField> createState() =>
      _RenewalPersonaldetailsFieldState();
}

class _RenewalPersonaldetailsFieldState
    extends State<RenewalPersonaldetailsField> {
          ...
          children: [
            ...
            size < mobilescreen
                ? TextFieldWidget(
                    ...
                    nextfocusnode: _pincodeFocusNode,
                    validator: () {
                      return authusecase.nameAuth(_addresscontroller.text);
                    })
                : const SizedBox(),
            const SizedBox(
              height: 10,
            ...
            size < mobilescreen
                ? TextFieldWidget(
                    ...
                    nextfocusnode: _homephoneFocusNode,
                    validator: () {
                      return authusecase.nameAuth(_occupationcontroller.text);
                    })
                : const SizedBox(),
            const SizedBox(
              height: 10,
            ...
            addmembrctrl.disability
                ? TextFieldWidget(
                    ...
                    nextfocusnode: _emergencynameFocusNode,
                    validator: () {
                      return authusecase.nameAuth(_disabilitycontroller.text);
                    }).animate().fadeIn()
                : const SizedBox(),
            ...
            addmembrctrl.relationship == 20
                ? TextFieldWidget(
                    ...
                    validator: addmembrctrl.relationship == 20
                        ? null
                        : () {
                            return authusecase.nameAuth(_othercontroller.text);
                          },
