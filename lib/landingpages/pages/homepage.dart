                ...
                actions: [
                           CardBorder(
                            ...
                            margin: const EdgeInsets.all(4),
                             ...
                             child: Text("Log In",style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: Colors.red[800],),),
                           ), 
                           ),
                           ...
                           CardwithShadow(
                            ...
                            padding: const EdgeInsets.symmetric(horizontal: 32,vertical: 8),
                             child:  const Text("Sign Up",style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: Colors.white),), 
                           ),
                            const SizedBox(width: 10,),
                ],
              ),
                    ...
                    children: [
                        ...
                        SizedBox(height: 80,),
                          Cardonly(
                            ...
                            color: landingctrl.page != 1 && landingctrl.page!=2?Theme.of(context).colorScheme.secondary:Colors.transparent,
                            onpress: (){
                                landingctrl.changelandingpage(1);
                              Get.toNamed("/home");
                            },
                            child: Text("Home",style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.onSecondary),)),
